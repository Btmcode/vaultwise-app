  ...
  return (
    ...
    >
       <g clipPath="url(#clip0_1_1)">
        ...
        <path d="M38.8398 21.293C40.4823 23.2702 41.4186 25.8849 41.4186 28.7106C41.4186 36.3353 35.4375 42.3164 27.8128 42.3164C22.8443 42.3164 18.539 39.4038 16.3885 35.1855L21.357 32.5707C22.6842 35.0986 25.0564 36.6455 27.8128 36.6455C32.449 36.6455 36.2088 33.1593 36.2088 28.6236C36.2088 24.1748 32.2757 20.6886 27.8128 20.6886C26.1704 20.6886 24.6101 21.2021 23.3681 22.0287L21.5309 17.2245C23.3681 16.311 25.4856 15.7007 27.8128 15.7007C31.7459 15.7007 35.4375 17.6741 37.588 20.6017L38.8398 21.293Z" fill="#F2A9-0" fillOpacity="0.7"/>
