      ...
      <CardHeader className="flex flex-col items-start justify-between gap-4 space-y-0 sm:flex-row sm:items-center sm:space-y-0">
        ...
        >
          <TabsList className="w-full">
            <TabsTrigger value="1d" className="text-xs px-2 sm:px-3">
              {dict.tabs["1d"]}
            </TabsTrigger>
            <TabsTrigger value="1w" className="text-xs px-2 sm:px-3">
              {dict.tabs["1w"]}
            </TabsTrigger>
            <TabsTrigger value="1m" className="text-xs px-2 sm:px-3">
              {dict.tabs["1m"]}
            </TabsTrigger>
            <TabsTrigger value="1y" className="text-xs px-2 sm:px-3">
              {dict.tabs["1y"]}
            </TabsTrigger>
          </TabsList>
        </Tabs>
